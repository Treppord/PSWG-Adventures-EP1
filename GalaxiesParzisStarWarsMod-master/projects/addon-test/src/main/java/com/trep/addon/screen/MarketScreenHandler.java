...
public class MarketScreenHandler extends ScreenHandler {
    ...
    public MarketScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory, PropertyDelegate delegate) {
        super(ModScreenHandlers.MARKET_STATION_SCREEN_HANDLER, syncId);
