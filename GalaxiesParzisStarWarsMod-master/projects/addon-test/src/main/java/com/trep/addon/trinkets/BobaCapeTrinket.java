...
public class BobaCapeTrinket extends TrinketItem implements TrinketRenderer {

    private static final Identifier TEXTURE = new Identifier(TestAddon.MODID, "textures/entity/trinket/cape_boba.png");
    private BipedEntityModel<LivingEntity> model;

    public BobaCapeTrinket(Settings settings) {
        super(settings);
    }
    ...
    private BipedEntityModel<LivingEntity> getModel() {
        if (this.model == null) {
            ...
            this.model = new BobaCapeTrinketModel(BobaCapeTrinketModel.getTexturedModelData().createModel());
        }
