...
public class BobaJetpackTrinket extends TrinketItem implements TrinketRenderer {

    private static final Identifier TEXTURE = new Identifier(TestAddon.MODID, "textures/armor/jetpack_2.png");
    private BipedEntityModel<LivingEntity> model;

    public BobaJetpackTrinket(Settings settings) {
        super(settings);
    }
    ...
    private BipedEntityModel<LivingEntity> getModel() {
        if (this.model == null) {
            ...
            this.model = new BobaJetpackTrinketModel(BobaJetpackTrinketModel.getTexturedModelData().createModel());
        }
