...
public class MandoCape2Trinket extends TrinketItem implements TrinketRenderer {

    private static final Identifier TEXTURE = new Identifier(TestAddon.MODID, "textures/entity/trinket/cape_mando_2.png");
    private BipedEntityModel<LivingEntity> model;

    public MandoCape2Trinket(Settings settings) {
        super(settings);
    }
    ...
    public Multimap<EntityAttribute, EntityAttributeModifier> getModifiers(ItemStack stack, SlotReference slot, LivingEntity entity, UUID uuid) {
        ...
        EntityAttributeModifier strengthModifier = new EntityAttributeModifier(uuid, "trinkets-testmod:knocky",
                2, EntityAttributeModifier.Operation.ADDITION);
        modifiers.put(EntityAttributes.GENERIC_ATTACK_KNOCKBACK, strengthModifier);
        return modifiers;
    }
    ...
    private BipedEntityModel<LivingEntity> getModel() {
        if (this.model == null) {
            ...
            this.model = new MandoCapeTrinketModel(MandoCapeTrinketModel.getTexturedModelData().createModel());
        }
