...
public class MandoCapeTrinket extends TrinketItem implements TrinketRenderer {

    private static final Identifier TEXTURE = new Identifier(TestAddon.MODID, "textures/entity/trinket/cape_mando.png");
    private BipedEntityModel<LivingEntity> model;

    public MandoCapeTrinket(Settings settings) {
        super(settings);
    }
