package com.example.addon.blocks;

import com.example.addon.blocks.entity.ArmorStationBlockEntity;
...
public class FabricatorBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, AdventureBlockEntities.ARMOR_STATION, ArmorStationBlockEntity::tick);
    }
}
