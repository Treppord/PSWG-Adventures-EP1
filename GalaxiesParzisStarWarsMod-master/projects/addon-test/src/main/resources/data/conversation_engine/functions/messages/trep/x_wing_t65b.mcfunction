...
execute store success score @s CE_resend if score @s CE_current_node matches 5 run scoreboard players set @s CE_suc 1
    ...
    execute if score @s CE_buy_count matches 32.. run clear @s pswg-addon-test:gold_credit 32
    execute if score @s CE_buy_count matches 32.. run give @s pswg:spawn_xwing_t65b 1
