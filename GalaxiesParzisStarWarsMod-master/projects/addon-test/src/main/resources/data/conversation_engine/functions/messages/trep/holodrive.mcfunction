...
execute store success score @s CE_resend if score @s CE_current_node matches 6 run scoreboard players set @s CE_suc 1
    ...
    execute if score @s CE_buy_count matches 4.. run clear @s pswg-addon-test:gold_credit 4
    execute if score @s CE_buy_count matches 4.. run give @s pswg-addon-test:holodrive 1
